...
activities = {
    ...
    "Yoga Club": {
        "description": "Practice yoga and mindfulness for strength, balance, and relaxation",
    ...
    "Science Club": {
        "description": "Explore science experiments and projects across multiple disciplines",
