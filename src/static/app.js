document.addEventListener("DOMContentLoaded", () => {
              ...
              .map(
                (participant) => `
                  <div class="participant-row">
                    ...
                    <button class="participant-delete" data-email="${participant}" data-activity="${name}" aria-label="Remove ${participant}">
                      ✕
                    </button>
                  </div>
                `
  ...
  activitiesList.addEventListener("click", (event) => {
    ...
    unregisterParticipant(deleteButton.dataset.email, deleteButton.dataset.activity);
  });
